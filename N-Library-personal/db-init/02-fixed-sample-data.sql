-- Fixed sample data for N-Library (matching Java model)
USE library_manage;

-- Insert sample admin user
INSERT INTO users (firstName, lastName, userNic, image, email, phoneNumber, address, password, active, userType) VALUES
('Admin', 'User', 'ADM001', 'default_user.png', 'admin@nlibrary.com', '0771234567', '123 Admin Street', 'admin123', TRUE, 'ADMIN');

-- Insert sample student user
INSERT INTO users (firstName, lastName, userNic, image, email, phoneNumber, address, password, active, userType) VALUES
('John', 'Doe', 'STU001', 'default_user.png', 'john@student.com', '0777654321', '456 Student Avenue', 'student123', TRUE, 'STUDENT');
